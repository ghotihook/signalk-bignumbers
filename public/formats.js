...
// The editor labels each entry "name — mask", so a name never repeats
// its layout.
const FORMATS = [
  { id: "angle-180", group: "Angle", name: "Wind angle, ±180°", factor: 57.29577951308232, unit: "°", layout: "xxx", neg: true, wrap: true },
  { id: "angle-360", group: "Angle", name: "Heading, course, direction, 0–360°", factor: 57.29577951308232, unit: "°", layout: "xxx" },
  { id: "angle-small", group: "Angle", name: "Heel, trim, rudder, ±99°", factor: 57.29577951308232, unit: "°", layout: "xx", neg: true },

  { id: "speed-kn", group: "Speed", name: "Knots", factor: 1.9438444924406, unit: "kt", layout: "xx.x" },
  { id: "speed-kn-2", group: "Speed", name: "Knots", factor: 1.9438444924406, unit: "kt", layout: "xx.xx" },
  ...
  { id: "depth-m", group: "Depth", name: "Metres", unit: "m", layout: "xx.x" },
  { id: "depth-ft", group: "Depth", name: "Feet", factor: 3.280839895013123, unit: "ft", layout: "xxx" },

  { id: "dist-nm", group: "Distance", name: "Nautical miles, trip", factor: 0.0005399568034557235, unit: "nm", layout: "xxx.x" },
  { id: "dist-nm-long", group: "Distance", name: "Nautical miles, log", factor: 0.0005399568034557235, unit: "nm", layout: "xxxxx.x" },
  ...
  { id: "dur-hms", group: "Time", name: "Duration", layout: "hh:mm:ss", mode: "duration" },
  { id: "dur-ms", group: "Time", name: "Duration", layout: "mm:ss", mode: "duration" },
  { id: "dur-hm", group: "Time", name: "Duration", layout: "hh:mm", mode: "duration" },
  { id: "clock-hms", group: "Time", name: "Clock, local time", layout: "hh:mm:ss", mode: "clock" },
  { id: "clock-hm", group: "Time", name: "Clock, local time", layout: "hh:mm", mode: "clock" },

  { id: "volts", group: "Electrical", name: "Volts", unit: "V", layout: "xx.x" },
  { id: "amps", group: "Electrical", name: "Amps", unit: "A", layout: "xxx.x", neg: true },
  ...
  { id: "count", group: "Number", name: "Count", layout: "xx" },
  { id: "num-0", group: "Number", name: "Whole number", layout: "xxxx" },
  { id: "num-1", group: "Number", name: "1 decimal", layout: "xxx.x" },
  { id: "num-2", group: "Number", name: "2 decimals", layout: "xx.xx" },
  { id: "num-1-neg", group: "Number", name: "1 decimal", layout: "xxx.x", neg: true },
];
